# Script en PHP para insertar parcelas en el Sector 2
...
Este script en PHP inserta parcelas en la tabla `parcelas`, basándose en la distribución de lotes y cantidades de parcelas especificadas para el **Sector 2**.
...
## Paso 2: Distribución de parcelas en el Sector 2
...
Guardar el siguiente código en un archivo llamado `insertar_parcelas_sector2.php`:
...
try {
    ...
    // Definir los lotes y su cantidad de parcelas en el Sector 2
    $lotes_parcelas = [
        1 => 12, 2 => 16, 3 => 16, 4 => 16, 5 => 32,
        6 => 32, 7 => 32, 8 => 48, 9 => 48, 10 => 48,
...
Para ejecutar el script de inserción de parcelas en el **Sector 2**, sigue estos pasos:

1. Guarda el código anterior en un archivo llamado `insertar_parcelas_sector2.php`.
2. Asegúrate de que PHP esté instalado en tu sistema.
3. En la terminal, navega a la carpeta donde guardaste el archivo.
4. Ejecuta el siguiente comando:

    ```sh
    php insertar_parcelas_sector2.php
    ```
...
-   "Parcela insertada: Lote X, Número Y, Descripción: Parcela Y, Lote X, Sector 2, Cliente ID: 185000"
-   "Parcela Y en Lote X ya existe, no se insertó."
-   "Advertencia: No se encontró lote X en sector 2, omitiendo inserción de parcelas."
