# Script en PHP para insertar parcelas en el Sector 5
...
Este script en PHP inserta parcelas en la tabla `parcelas`, basándose en la distribución de lotes y cantidades de parcelas especificadas para el **Sector 5**.
...
## Paso 2: Distribución de parcelas en el Sector 5
...
Guardar el siguiente código en un archivo llamado `insertar_parcelas_sector5.php`:
...
try {
    ...
    // Definir los lotes y su rango de parcelas en el Sector 5
    $lotes_parcelas = [
...
Para ejecutar el script de inserción de parcelas en el **Sector 5**, sigue estos pasos:

1. Guarda el código anterior en un archivo llamado `insertar_parcelas_sector5.php`.
2. Asegúrate de que PHP esté instalado en tu sistema.
3. En la terminal, navega a la carpeta donde guardaste el archivo.
4. Ejecuta el siguiente comando:

    ```sh
    php insertar_parcelas_sector5.php
    ```
...
-   "Parcela insertada: Lote X, Número Y, Descripción: Parcela Y, Lote X, Sector 5, Cliente ID: 185000"
-   "Parcela Y en Lote X ya existe, no se insertó."
-   "Advertencia: No se encontró lote X en sector 5, omitiendo inserción de parcelas."
